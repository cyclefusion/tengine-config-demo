...
Source201:	   ngx_realtime_request_module-master.zip
# https://github.com/agentzh/redis2-nginx-module
Source202:	   redis2-nginx-module-0.10.zip
...
%{buildroot}%{_sbindir}/dso_tool --dst=%{buildroot}%{_libdir}/%{name}/modules --nginx-source=`pwd` --add-module=`pwd`/redis2-nginx-module-0.10
...
install -p -m 0644 %{SOURCE105} %{buildroot}%{tengine_confdir}/conf.d
